...
public class Planet {
    ...
    private static int[] iconArray = {R.drawable.shuixing, R.drawable.jinxing, R.drawable.diqiu,
            R.drawable.huoxing, R.drawable.muxing, R.drawable.tuxing, R.drawable.hzl1, R.drawable.zz, R.drawable.xxl, R.drawable.jz};
    private static String[] nameArray = {"水星", "金星", "地球", "火星", "木星", "土星", "黄星", "高星", "许星", "姬星"};
